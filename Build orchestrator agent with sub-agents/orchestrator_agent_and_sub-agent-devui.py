...
######## Example inputs #######
# Design a secure Azure Storage Account deployment for a production application.
# Create an Azure Container Apps architecture for hosting an MCP server.
# Design a highly available web application using Azure App Service and Azure SQL.
# Create an Azure CLI deployment guide for a private AKS cluster.
# Plan the migration of an on-premises application to Azure.
# Design a secure RAG application using Azure AI Search and Microsoft Foundry.
# Create a disaster recovery strategy for an Azure-hosted banking application.
# Compare Azure Functions and Azure Container Apps for an event-driven workload and recommend an implementation